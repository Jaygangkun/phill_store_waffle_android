...
import com.edelivery.store.StoreDeliveryTimeActivity;
...
public class StoreDeliveryTimeAdapter extends RecyclerView.Adapter<StoreDeliveryTimeAdapter.ViewHolder>
        implements View.OnClickListener {

    private ArrayList<DayTime> storeTimeList;
    private StoreDeliveryTimeActivity storeTimeActivity;

    public StoreDeliveryTimeAdapter(ArrayList<DayTime> storeOpenTimeList, StoreDeliveryTimeActivity
            storeTimeActivity) {
