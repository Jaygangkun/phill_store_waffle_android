package com.edelivery.store.sunmi.utils;
...
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
     ...
     * 打印二维码
     */
    public void printQr(String data, String Lable, int allign, int modulesize, int errorlevel) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        try {
            woyouService.setAlignment(allign, null);
            woyouService.printQRCode(data, modulesize, errorlevel, null);
            woyouService.setAlignment(allign, null);
            woyouService.printTextWithFont(Lable.concat("\n"), null, 14, null);
//            woyouService.lineWrap(-9, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
     ...
     * 打印二维码
     */
    public void printRightQr(String data, String Lable, int modulesize, int errorlevel) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        try {
            ...
            woyouService.printQRCode(data, modulesize, errorlevel, null);
            woyouService.printTextWithFont(Lable, null, 14, null);
...
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            if (PreferenceHelper.getPreferenceHelper(context).getLanguageCode().equals("ar")) {
                woyouService.setAlignment(2, null);
            } else {
...
//            woyouService.lineWrap(3, null);
    ...
    public void printDarkText(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
...
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
    ...
    public void printDivider(float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        try {
            String content = "_____________________________________".concat("\n");
            if (isBold) {
                woyouService.sendRAWData(ESCUtil.boldOn(), null);
            } else {
                woyouService.sendRAWData(ESCUtil.boldOff(), null);
    ...
    public void printDeshDivider(float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
...
//            woyouService.lineWrap(3, null);
     ...
     * 打印表格
     */
    public void printTable(LinkedList<TableItem> list, float size, boolean isBold) {
        if (woyouService == null) {
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
