...
import com.edelivery.store.adapter.StoreTimeAdapter;
...
public class StoreTimeActivity extends BaseActivity {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            if (isValidOpeningTime(dayTime)) {
                                ...
                                Utilities.showToast(StoreTimeActivity.this, getString(R.string
                                        .text_not_valid_Time));
                            }
                        } else {
                            if (count == 0) {
    ...
    private void updateStoreTime(String pass, String socialId) {
        ...
        updateStoreTime.setStoreTime(storeTimeList);
            ...
            public void onResponse(Call<IsSuccessResponse> call, Response<IsSuccessResponse>
                ...
                if (parseContent.isSuccessful(response)) {
                    if (response.body().isSuccess()) {
                        ParseContent.getParseContentInstance().showMessage(StoreTimeActivity
                                        .this,
                                response.body().getMessage());
                        setResult(Activity.RESULT_OK);
                        finish();
                    } else {
                        ParseContent.getParseContentInstance().showErrorMessage(StoreTimeActivity
